...
},{"./jsl":17}],5:[function(require,module,exports){
'use strict';
...
var Canvas = function () {
	function Canvas(dom) {
		...
		this.dom = (0, _jquery2.default)(dom)[0];
	...
	_createClass(Canvas, [{
		...
		value: function refresh() {
			this.ctx.canvas.width = (0, _jquery2.default)(this.ctx.canvas).width();
			this.ctx.canvas.height = (0, _jquery2.default)(this.ctx.canvas).height();
		}
	}]);
...
},{"./rect":9,"./vector2":10,"jquery":1}],8:[function(require,module,exports){
'use strict';
...
var Grid = function (_Canvas) {
	...
	_createClass(Grid, [{
		...
		value: function refresh() {
			...
			ctx.canvas.width = (0, _jquery2.default)(ctx.canvas.parentNode).width();
			ctx.canvas.height = (0, _jquery2.default)(ctx.canvas.parentNode).height();
...
},{"../etc/counter":5,"./canvas":7,"./rect":9,"./vector2":10,"jquery":1,"lodash":2}],9:[function(require,module,exports){
'use strict';
...
},{"./vector2":10}],10:[function(require,module,exports){
'use strict';
...
var View = function () {
	function View(dom, config) {
		...
		this.dom = (0, _jquery2.default)(dom);
		...
		this.layers = {
			grid: new _grid2.default((0, _jquery2.default)('canvas.grid')[0], this.config),
			elements: new _canvas2.default((0, _jquery2.default)('canvas.elements')[0]),
			interaction: new _canvas2.default((0, _jquery2.default)('canvas.interaction')[0])
		};
	}
...
},{"../etc/signal":6,"./canvas":7,"./grid":8,"./rect":9,"./vector2":10,"jquery":1}],12:[function(require,module,exports){
'use strict';
...
},{"./editor":12,"./piano-roll":14,"./sequencer":15,"./studio":16}],14:[function(require,module,exports){
'use strict';
...
var PianoRoll = function (_Editor) {
	...
	function PianoRoll(dom) {
		...
		_this.view = new _view2.default((0, _jquery2.default)(_this.dom).find('.view')[0], _this.viewConfig);
	...
	_createClass(PianoRoll, [{
		...
		value: function init() {
			...
			(0, _jquery2.default)(this.dom).on('click', '[class*=\'-option\']', function (_ev) {
				var _optionParam = (0, _jquery2.default)(this).data('option-param');
				var _optionValue = (0, _jquery2.default)(this).data('option-value');

				(0, _jquery2.default)(pianoRoll.dom).find('.' + _optionParam + '-option').removeClass('selected');
...
},{"../../config/measure":3,"../gfx/view":11,"./editor":12,"jquery":1}],15:[function(require,module,exports){
'use strict';
...
var Sequencer = function (_Editor) {
	...
	_createClass(Sequencer, [{
		...
		value: function init() {
			...
			(0, _jquery2.default)(this.dom).on('mousedown', '.bar', function () {
				mousedown = true;
				lastBar = this;
			...
			(0, _jquery2.default)(this.dom).on('mousemove', '.bar', function () {
			...
			(0, _jquery2.default)('body').on('mouseup', function () {
				mousedown = false;
				lastBar = false;
			});

			(0, _jquery2.default)(this.dom).on('change', '#bar-count', function () {
				sequencer.track.bars = (0, _jquery2.default)(this).val();
				sequencer.redraw();
				sequencer.refresh();
			});
		...
		key: 'redraw',
		value: function redraw() {
			var jQuerychannels = (0, _jquery2.default)(this.dom).find('.channels');
			jQuerychannels.html('');
			if (this.track && this.track.channels) {
				this.track.channels.forEach(function (channel, index) {
					var jQuerychannel = (0, _jquery2.default)('<div></div>').addClass('channel').attr('id', 'channel' + index);
					jQuerychannel.append((0, _jquery2.default)('<div></div>').addClass('channel-name').html(channel.name));
					jQuerychannel.append((0, _jquery2.default)('<input></input>').addClass('channel-note').val(channel.note));
					var jQuerybars = (0, _jquery2.default)('<div></div>').addClass('bars');

					var patternIndex = 0;
					for (var bar = 0; bar < (0, _jquery2.default)('#bar-count').val(); bar++) {
						var jQuerybar = (0, _jquery2.default)('<div></div>').addClass('bar').attr('id', 'channel' + index + '-bar' + bar);
						if (channel.pattern) {
		...
		value: function refresh() {
			...
			if (sequencer.track) {
				...
				(0, _jquery2.default)(this.dom).find('.bars').each(function (channelIndex) {
					sequencer.track.channels[channelIndex].pattern = [];
					(0, _jquery2.default)(this).find('.bar').each(function (barIndex) {
		...
		value: function link(track) {
			this.track = track;
			(0, _jquery2.default)(this.dom).find('#bar-count').val(track.bars);
			this.redraw();
			this.refresh();
		}
	}, {
		...
		value: function tick(barIndex) {
			(0, _jquery2.default)(this.dom).find('.bars').each(function () {
				(0, _jquery2.default)(this).find('.bar').removeClass('current');
			});

			(0, _jquery2.default)(this.dom).find('.bars').each(function (channelIndex) {
				(0, _jquery2.default)(this).find('.bar').eq(barIndex).each(function () {
...
},{"./editor":12,"jquery":1}],16:[function(require,module,exports){
'use strict';
...
var Studio = function (_Editor) {
	...
	function Studio(dom, context) {
		...
		_this.sequencer = new _sequencer2.default((0, _jquery2.default)('.sequencer')[0]);
		_this.pianoRoll = new _pianoRoll2.default((0, _jquery2.default)('.piano-roll')[0]);
		return _this;
	}
	...
	_createClass(Studio, [{
       ...
       */
		...
		value: function load(data) {
			...
			(0, _jquery2.default)('#bpm').val(this.song.bpm);
		...
		value: function init() {
			...
			(0, _jquery2.default)('#play').click(function () {
				if (playLoop) {
					...
					var bpm = parseInt((0, _jquery2.default)('#bpm').val(), 10);
     	...
     	song.tracks[1].events.forEach(function(event) {
			...
			(0, _jquery2.default)('#stop').click(function () {
				...
				playLoop = false;
				(0, _jquery2.default)('.bars').each(function () {
					(0, _jquery2.default)(this).find('.bar').removeClass('current');
				});

				studio.tickIndex = -1;

				(0, _jquery2.default)('#play').removeClass('active');
			});

			(0, _jquery2.default)('#bpm').change(function () {
				song.bpm = (0, _jquery2.default)(this).val();
				if (playLoop) {
					clearInterval(playLoop);
					playLoop = setInterval(function () {
						studio.tick();
					}, 60 / (0, _jquery2.default)('#bpm').val() * 1000 / 4);
				}
			});
			...
			(0, _jquery2.default)('#load').click(function () {
				(0, _jquery2.default)('#load-file').click();
			});

			(0, _jquery2.default)('#load-file').change(function () {
...
},{"../instr/basic-synth":18,"../instr/sampler":19,"./editor":12,"./piano-roll":14,"./sequencer":15,"jquery":1}],17:[function(require,module,exports){
"use strict";
...
},{"./gui":13}],18:[function(require,module,exports){
'use strict';
