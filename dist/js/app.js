...
var Grid = function (_Canvas) {
	...
	function Grid(dom, conf) {
		...
		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Grid).call(this, dom));
						...
						case 'moving':
							{
								...
								var _ret = function () {
									...
									xSteps = parseInt(Math.abs(changeSinceLast.x) / grid.conf.step.x, 10);
									ySteps = parseInt(Math.abs(changeSinceLast.y) / grid.conf.step.y, 10);
...
var PianoRoll = function (_Editor) {
	...
	function PianoRoll(dom) {
		...
		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PianoRoll).call(this, dom));
	...
	_createClass(PianoRoll, [{
		key: 'init',
		value: function init() {
			_get(Object.getPrototypeOf(PianoRoll.prototype), 'init', this).call(this);
			this.view.init();
...
var Sequencer = function (_Editor) {
	...
	function Sequencer(dom, context) {
		...
		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Sequencer).call(this, dom, context));
	...
	_createClass(Sequencer, [{
		...
		value: function init() {
			...
			_get(Object.getPrototypeOf(Sequencer.prototype), 'init', this).call(this, this);
...
var Studio = function (_Editor) {
	...
	function Studio(dom, context) {
		...
		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Studio).call(this, dom, context));
